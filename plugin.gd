...
func _enter_tree():
	...
	#add_custom_type("AeroSurface3D", "AeroInfluencer3D", aero_surface_3d, aerosurface3d_icon)
	add_custom_type("AeroSurfaceConfig", "Resource", aero_surface_config, object_icon)
	#add_custom_type("ManualAeroSurface3D", "AeroInfluencer3D", manual_aero_surface_3d, aerosurface3d_icon)
