...
func _calculate_forces(substep_delta : float = 0.0) -> PackedVector3Array:
	...
	drag_force = aero_reference * manual_config.get_drag_coefficient(angle_of_attack) * manual_config.get_drag_at_sweep_angle(sweep_angle) * manual_config.get_drag_multiplier_at_mach(mach)
