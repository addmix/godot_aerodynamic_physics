...
func _enter_tree():
	...
	PluginUtils.ifndef("physics/3d/aerodynamics/substeps", 1)
	add_custom_type("AeroSurface", "Spatial", preload("./core/aero_surface.gd"), preload("./icons/node3d.svg"))
	add_custom_type("AeroBody", "RigidBody", preload("./core/aero_body.gd"), preload("./icons/node3d.svg"))
