...
void AeroInfluencer3D::_bind_methods() {
	...
	ADD_PROPERTY(PropertyInfo(Variant::OBJECT, "aero_body", PROPERTY_HINT_NODE_TYPE, "AeroBody3D"), "", "get_aero_body");
	
	ClassDB::bind_method(D_METHOD("get_default_transform"), &AeroInfluencer3D::get_default_transform);
	ADD_PROPERTY(PropertyInfo(Variant::TRANSFORM3D, "default_transform"), "", "get_default_transform");
	...
	ADD_PROPERTY(PropertyInfo(Variant::VECTOR3, "linear_velocity"), "", "get_linear_velocity");
	ClassDB::bind_method(D_METHOD("get_angular_velocity"), &AeroInfluencer3D::get_angular_velocity);
	ADD_PROPERTY(PropertyInfo(Variant::VECTOR3, "angular_velocity"), "", "get_angular_velocity");
	...
	ADD_PROPERTY(PropertyInfo(Variant::VECTOR3, "drag_direction"), "", "get_drag_direction");
	...
	ADD_PROPERTY(PropertyInfo(Variant::FLOAT, "dynamic_pressure"), "", "get_dynamic_pressure");
	//ClassDB::bind_method(D_METHOD("get_centrifugal_offset"), &AeroInfluencer3D::get_centrifugal_offset);
	//ADD_PROPERTY(PropertyInfo(Variant::VECTOR3, "centrifugal"), "", "get_centrifugal_offset");
	//ClassDB::bind_method(D_METHOD("get_linear_acceleration"), &AeroInfluencer3D::get_linear_acceleration);
	//ADD_PROPERTY(PropertyInfo(Variant::VECTOR3, "aero_body"), "", "get_linear_acceleration");
	//ClassDB::bind_method(D_METHOD("get_angular_acceleration"), &AeroInfluencer3D::get_angular_acceleration);
	//ADD_PROPERTY(PropertyInfo(Variant::VECTOR3, "aero_body"), "", "get_angular_acceleration");
